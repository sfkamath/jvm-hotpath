...
class MicronautAgentIT {
    ...
    void testAgentInstrumentsMicronautApp() throws Exception {
        ...
        // We use the same target directory as SpringBootAgentIT, but maybe we should ensure they don't overlap if run in parallel.
        ...
        assertTrue(thresholdReached, "Report should have reached 50+ executions for MicronautGreetingService.");
