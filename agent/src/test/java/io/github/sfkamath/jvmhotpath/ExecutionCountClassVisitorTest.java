...
class ExecutionCountClassVisitorTest {
  ...
  void testVisitorWithLineNumbers() {
    ...
    visitor.visit(
        Opcodes.V11, Opcodes.ACC_PUBLIC, "com/example/Test", null, "java/lang/Object", null);
  ...
  void testVisitorWithoutLineNumbers() {
    ...
    visitor.visit(
        Opcodes.V11, Opcodes.ACC_PUBLIC, "com/example/NoLines", null, "java/lang/Object", null);
    MethodVisitor mv = visitor.visitMethod(Opcodes.ACC_PUBLIC, "run", "()V", null, null);
    mv.visitCode();
    mv.visitInsn(Opcodes.RETURN);
    mv.visitMaxs(1, 1);
